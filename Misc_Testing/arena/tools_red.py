...
# Compact msfvenom reference — only the syntax, not the full payload/encoder lists
...
def red_generate_exploits(filename: str) -> str:
    ...
    # Build a compact prompt that fits in the model's context
...
Return ONLY valid JSON, no explanation."""
    ...
    chat = lms.Chat("You generate msfvenom payload plans as JSON. Return only valid JSON.")
